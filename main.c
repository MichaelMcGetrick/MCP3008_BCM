...
#define DATA_ARRAY_FLAG	0 //1: create data array of samples for metric test;   
#define LINUX				0
#define RTC					1
...
//char *filename = "linux_metrics_clk_0_68_fastloop.csv";
char *filename = "bcm_linux_timer_integrity.csv";
